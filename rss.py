...
starting_location = spawn_points[19]  # spawn_points[1] Town03  Near starting fountain
...
def get_long_distances(ego, v_actors):
    ...
    for v in v_actors:
        ...
        s = longitudinal_dist(ego_s, v_s, min_path_roads)
        distances.append(s)
...
while True:
    try:
        world.tick()
        dt += 1
        d = get_long_distances(bmw, [jeep])[0]
